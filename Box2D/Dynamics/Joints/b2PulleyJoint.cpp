...
void b2PulleyJoint::Dump()
{
    ...
    b2Log("  jd.groundAnchorA.Set(%.15lef, %.15lef);\n", static_cast<double>(m_groundAnchorA.x), static_cast<double>(m_groundAnchorA.y));
    b2Log("  jd.groundAnchorB.Set(%.15lef, %.15lef);\n", static_cast<double>(m_groundAnchorB.x), static_cast<double>(m_groundAnchorB.y));
    ...
    b2Log("  jd.lengthA = %.15lef;\n", static_cast<double>(m_lengthA));
    b2Log("  jd.lengthB = %.15lef;\n", static_cast<double>(m_lengthB));
    b2Log("  jd.ratio = %.15lef;\n", static_cast<double>(m_ratio));
