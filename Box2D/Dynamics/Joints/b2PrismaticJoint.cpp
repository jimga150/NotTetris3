...
void b2PrismaticJoint::Dump()
{
    ...
    b2Log("  jd.localAnchorA.Set(%.15lef, %.15lef);\n", static_cast<double>(m_localAnchorA.x), static_cast<double>(m_localAnchorA.y));
    b2Log("  jd.localAnchorB.Set(%.15lef, %.15lef);\n", static_cast<double>(m_localAnchorB.x), static_cast<double>(m_localAnchorB.y));
    b2Log("  jd.localAxisA.Set(%.15lef, %.15lef);\n", static_cast<double>(m_localXAxisA.x), static_cast<double>(m_localXAxisA.y));
    b2Log("  jd.referenceAngle = %.15lef;\n", static_cast<double>(m_referenceAngle));
    b2Log("  jd.enableLimit = bool(%d);\n", m_enableLimit);
    b2Log("  jd.lowerTranslation = %.15lef;\n", static_cast<double>(m_lowerTranslation));
    b2Log("  jd.upperTranslation = %.15lef;\n", static_cast<double>(m_upperTranslation));
    b2Log("  jd.enableMotor = bool(%d);\n", m_enableMotor);
    b2Log("  jd.motorSpeed = %.15lef;\n", static_cast<double>(m_motorSpeed));
    b2Log("  jd.maxMotorForce = %.15lef;\n", static_cast<double>(m_maxMotorForce));
