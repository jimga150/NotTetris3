...
b2ContactSolver::b2ContactSolver(b2ContactSolverDef* def)
{
    ...
    m_count = def->count;
    m_positionConstraints = static_cast<b2ContactPositionConstraint*>(m_allocator->Allocate(m_count * SIZEOF_INT(b2ContactPositionConstraint)));
    m_velocityConstraints = static_cast<b2ContactVelocityConstraint*>(m_allocator->Allocate(m_count * SIZEOF_INT(b2ContactVelocityConstraint)));
