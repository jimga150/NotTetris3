...
void b2Body::Dump()
{
    ...
    b2Log("  bd.position.Set(%.15lef, %.15lef);\n", static_cast<double>(m_xf.p.x), static_cast<double>(m_xf.p.y));
    b2Log("  bd.angle = %.15lef;\n", static_cast<double>(m_sweep.a));
    b2Log("  bd.linearVelocity.Set(%.15lef, %.15lef);\n", static_cast<double>(m_linearVelocity.x), static_cast<double>(m_linearVelocity.y));
    b2Log("  bd.angularVelocity = %.15lef;\n", static_cast<double>(m_angularVelocity));
    b2Log("  bd.linearDamping = %.15lef;\n", static_cast<double>(m_linearDamping));
    b2Log("  bd.angularDamping = %.15lef;\n", static_cast<double>(m_angularDamping));
